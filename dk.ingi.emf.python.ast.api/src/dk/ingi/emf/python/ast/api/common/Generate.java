package dk.ingi.emf.python.ast.api.common;
...
public class Generate extends AbstractAcceleoGenerator {
	public static final String AST_META_MODEL = "../dk.ingi.emf.python.ast/model/ast.ecore";
	public static final String VISITOR_OUTPUT = "src-gen";
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/dk/ingi/emf/python/ast/api/common/generate";
	...
	public static void main(String[] args) {
		try {
			...
			URI modelURI = URI.createFileURI(AST_META_MODEL);
			File directory = new File(VISITOR_OUTPUT);
			directory.mkdirs();
			if (!directory.isDirectory()) {
				System.err.println("Failed to create output directory: " + directory);
				final int posixENOENT = 2; 
				System.exit(posixENOENT);
			}
			...
			Generate generator = new Generate(modelURI, directory, arguments);
